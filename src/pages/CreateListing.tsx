...
import { Upload, Image, DollarSign, AlertCircle, Search } from 'lucide-react'
      ...
      const mockNFTs: NFTMetadata[] = [
        {
          ...
          description: 'A rare cosmic explorer NFT with unique space attributes. This NFT represents the first explorer to venture into the unknown depths of the cosmos.',
          attributes: [
        ...
        },
        {
          ...
          description: 'An underwater explorer discovering the mysteries of the deep ocean. This NFT represents the spirit of exploration and discovery.',
          attributes: [
            { trait_type: 'Depth', value: '10,000m' },
            { trait_type: 'Creature', value: 'Giant Squid' },
            { trait_type: 'Equipment', value: 'Advanced Submarine' },
  ...
  if (!isInitialized) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-dark-400">
          The marketplace needs to be initialized before you can create listings.
        </p>
      </div>
    )
  }
